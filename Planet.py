...
class Planet:
    AU = 149.6e6 * 1000  # an au in meters
    G = 6.67428e-11
    SCALE = 200 / AU  # 1AU = 100 pixels
    TIMESTEPS = 3600 * 24  # 1 Day
    ...
    def update_position(self, planets):
        ...
        self.x_vel += total_fx / self.mass * self.TIMESTEPS
        self.y_vel += total_fy / self.mass * self.TIMESTEPS

        self.x += self.x_vel * self.TIMESTEPS
        self.y += self.y_vel * self.TIMESTEPS
...
def main():
    ...
    jupiter = Planet(1.832 * Planet.AU, 0, 20, ORANGE, 6.323 * 10 ** 23)
    jupiter.y_vel = -22.0099 * 1000
